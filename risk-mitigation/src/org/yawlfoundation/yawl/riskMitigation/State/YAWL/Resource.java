...
public class Resource implements Cloneable{
	String id = null;
	LinkedList<String> offeredList = new LinkedList<String>();
	LinkedList<String> allocatedList = new LinkedList<String>();
	LinkedList<String> startedList = new LinkedList<String>();
