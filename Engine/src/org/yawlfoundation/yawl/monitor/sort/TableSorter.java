...
public class TableSorter {
	...
	public static enum SensorColumn { Case, SensorName, SensorMessage, SensorStatus, SensorProbability, SensorConsequence, SensorProbabilityXConsequence, SensorTimeStamp, Undefined }
    ...
    private SensorOrder sensorOrder;
    private CaseOrder caseOrder;
    private ItemOrder itemOrder;
    private ParamOrder paramOrder;

    public TableSorter() {
    	sensorOrder = new SensorOrder(SensorColumn.Undefined);
    ...
    public List<YSensorNotification> sort(List<YSensorNotification> sensorList, SensorColumn column) {
        sensorOrder.setOrder(column);
        return applySensorOrder(sensorList);
    }

    public List<YSensorNotification> applySensorOrder(List<YSensorNotification> sensorList) {
        if (sensorList != null) Collections.sort(sensorList, getCurrentSensorComparator());
        return sensorList;
    }

    public SensorOrder getSensorOrder() { return sensorOrder; }
    
    private Comparator<YSensorNotification> getCurrentSensorComparator() {
        return YSensorNotificationComparator.getComparator(sensorOrder);
    }
