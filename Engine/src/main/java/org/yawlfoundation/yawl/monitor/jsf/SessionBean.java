...
public class SessionBean extends AbstractSessionBean {
    ...
    private Button btnMitigate = new Button();

    public Button getBtnMitigate() { return btnMitigate; }

    public void setBtnMitigate(Button btn) { btnMitigate = btn; }
    ...
    List<YSensorNotification> sensorNotificationList = initSensorNotificationList();
    
    public List<YSensorNotification> initSensorNotificationList() { 
    	return _monClient.getSensorNotifications();
    }
    
    public List<YSensorNotification> getSensorNotificationList() { return sensorNotificationList;}
    
    public void setSensorNotificationList(List<YSensorNotification> notification) { sensorNotificationList = notification;}
    
    
    YSensorNotification sensorNotification;
    
    public YSensorNotification getSensorNotification() { return sensorNotification;}
    
    public void setSensorNotification(YSensorNotification sensor) { 
    	sensorNotification = sensor;
    	setSensorCaseID(sensorNotification.getCaseID());
    	setSensorName(sensorNotification.getSensorName());
    	setSensorMessage(sensorNotification.getSensorMessage());
    	setSensorTrigger(sensorNotification.getSensorTrigger());
    	setSensorTimeStamp(sensorNotification.getSensorTimeStamp());
    }
    
    public void deleteSensorNotification(YSensorNotification sensor) {
    	getApplicationBean().getMonitorClient().removeSensorNotification(sensor);
    }
    
    public void setSensorSelected(int i) {
    	setSensorNotification(sensorNotificationList.get(i));
    }
    
    
    public List<YSensorNotification> refreshSensorNotification(boolean sortPending) {
        sensorNotificationList = getApplicationBean().getMonitorClient().getSensorNotifications();
		if (! sortPending) sensorNotificationList = _sorter.applySensorOrder(sensorNotificationList);
        return sensorNotificationList;
    }
    
    
    public void sortSensorNotification(TableSorter.SensorColumn column) {
        refreshSensorNotification(true);
        sensorNotificationList = _sorter.sort(sensorNotificationList, column);
    }


    public SensorOrder getCurrentSensorOrder() {
        return _sorter.getSensorOrder();
    }
    
    
    String sensorCaseID;
    
    public String getSensorCaseID() { return sensorCaseID;}
    
    public void setSensorCaseID(String caseID) { sensorCaseID = caseID;}
    ...
    public void setSensorMessage(String message) { this.sensorMessage = message;}
	
	
    private String sensorTrigger;
	
    public String getSensorTrigger() { return sensorTrigger;}

    public void setSensorTrigger(String trigger) { this.sensorTrigger = trigger;}
    ...
    public void setSensorTimeStamp(String timeStamp) { this.sensorTimeStamp = timeStamp;}
    
    
    private String sensorMitigation;
	
    public String getSensorMitigation() { return sensorMitigation;}

    public void setSensorMitigation(String sensorMitigation) { this.sensorMitigation = sensorMitigation;}
    
    
    public void mitigate(YSensorNotification sensor) {
    	if(sensor != null) {
	    	String caseID = sensor.getCaseID();
	    	setSensorMitigation(_monClient.mitigate(caseID));
    	}  else {
    		setSensorMitigation("error");
    	}
    }
