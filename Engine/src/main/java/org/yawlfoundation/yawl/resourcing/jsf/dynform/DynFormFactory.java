...
public class DynFormFactory extends AbstractSessionBean {
    ...
    private String btnPredictStyle ;

    public String getBtnPredictStyle() { return btnPredictStyle; }

    public void setBtnPredictStyle(String style) { btnPredictStyle = style; }
    ...
    private void positionButtons(int width, int height, int top) {
        ...
        if(btnCount == 4) {
        	btnBlockWidth = (3 * FORM_BUTTON_WIDTH) + (FORM_BUTTON_GAP * (2));
        }
...
//            int btnPredictLeft = btnCompleteLeft + FORM_BUTTON_WIDTH + FORM_BUTTON_GAP;
            int btnPredictLeft = btnCompleteLeft;
