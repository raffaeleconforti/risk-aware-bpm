...
public class AlignTopAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, SpecificationSelectionSubscriber {
    ...
    
  {
    ...
    putValue(NAME, "Align along Top Edges");
    putValue(LONG_DESCRIPTION, "Align the selected elements their top edges.");
    putValue(SMALL_ICON, getPNGIcon("shape_align_top"));
