...
public class ZoomActualSizeAction extends YAWLSelectedNetAction {
  ...
  {
    putValue(SHORT_DESCRIPTION, " Zoom to actual size ");
    putValue(NAME, "Zoom to actual size");
    putValue(LONG_DESCRIPTION, "Zoom to on this net.");
    putValue(SMALL_ICON, getIconByName("ZoomActual"));
  }
