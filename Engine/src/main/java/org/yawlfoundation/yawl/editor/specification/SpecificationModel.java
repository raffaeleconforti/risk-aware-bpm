...
public class SpecificationModel {
   ...
   * Namely {org.yawlfoundation.yawl.risk.state.NO_NETS_EXIST},  {org.yawlfoundation.yawl.risk.state.NETS_EXIST},
   * {org.yawlfoundation.yawl.risk.state.NO_NET_SELECTED}, {SOME_NET_SELECTED}.
   * @param subscriber
   ...
   * org.yawlfoundation.yawl.risk.state that the subscriber has defined as being important to it. The subscriber
