...
public class ZoomSelectedElementsAction extends YAWLSelectedNetAction implements SpecificationSelectionSubscriber  {
  ...
  {
    putValue(SHORT_DESCRIPTION, " Zoom to selected elements ");
    putValue(NAME, "Zoom to selected elements");
    putValue(LONG_DESCRIPTION, "Zoom to selected elements.");
    putValue(SMALL_ICON, getPNGIcon("magnifier"));
  }
