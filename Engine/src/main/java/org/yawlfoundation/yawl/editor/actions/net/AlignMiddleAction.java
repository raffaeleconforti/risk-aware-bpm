...
public class AlignMiddleAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, SpecificationSelectionSubscriber {
    ...
    
  {
    ...
    putValue(NAME, "Align along Horizontal Centre");
    putValue(LONG_DESCRIPTION, "Horizontally align the selected elements along their centre.");
    putValue(SMALL_ICON, getPNGIcon("shape_align_middle"));
    putValue(MNEMONIC_KEY, new Integer(java.awt.event.KeyEvent.VK_H));
  }
