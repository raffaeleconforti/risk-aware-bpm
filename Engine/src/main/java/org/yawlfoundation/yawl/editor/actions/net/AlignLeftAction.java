...
public class AlignLeftAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, SpecificationSelectionSubscriber  {
    ...
    
  {
    ...
    putValue(NAME, "Align along Left Edges");
    putValue(LONG_DESCRIPTION, "Align the selected elements along their left edges.");
    putValue(SMALL_ICON, getPNGIcon("shape_align_left"));
    putValue(MNEMONIC_KEY, new Integer(java.awt.event.KeyEvent.VK_L));
  }
