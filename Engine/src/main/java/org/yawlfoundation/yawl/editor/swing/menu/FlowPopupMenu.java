...
class TogglePointAction extends YAWLSelectedNetAction {
  ...
  {
    putValue(SHORT_DESCRIPTION, "Add or remove bend");
    putValue(NAME, "Add or remove bend");
    putValue(LONG_DESCRIPTION, "Add or remove bend");
...
abstract class LineStyleAction extends YAWLSelectedNetAction {
  ...
  public LineStyleAction(NetGraph net, YAWLFlowRelation flow) {
    putValue(SHORT_DESCRIPTION, getStyleText() + " line style");
    putValue(NAME, getStyleText()  + " line style");
    putValue(LONG_DESCRIPTION, getStyleText() + " line style");
