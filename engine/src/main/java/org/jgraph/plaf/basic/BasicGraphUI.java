...
public class BasicGraphUI extends GraphUI implements Serializable {
	 ...
	 * means the cell's selection org.yawlfoundation.yawl.risk.state is inverted.
	 */
...
//		}
	...
	protected void updateCachedPreferredSize() {
		// FIXME: Renderer for the views might have an old org.yawlfoundation.yawl.risk.state
	...
	public class GraphLayoutCacheHandler implements GraphLayoutCacheListener,
		 ...
		 * (non-Javadoc)
		 * 
		 * @see GraphLayoutCacheListener#graphLayoutCacheChanged(GraphLayoutCacheEvent)
		 */
	...
	public class RootHandle implements CellHandle, Serializable {
		...
		/* Paint the handles. Use overlay to paint the current org.yawlfoundation.yawl.risk.state. */
	...
	public class GraphDropTargetListener extends BasicGraphDropTargetListener
		...
		/**
		 * called to save the org.yawlfoundation.yawl.risk.state of a component in case it needs to be
		...
		/**
		 * called to restore the org.yawlfoundation.yawl.risk.state of a component because a drop was not
		 * performed.
		 */
		...
		protected void updateInsertionLocation(JComponent comp, Point p) {
			...
			if (handle != null) {
				// How to fetch the shift org.yawlfoundation.yawl.risk.state?
