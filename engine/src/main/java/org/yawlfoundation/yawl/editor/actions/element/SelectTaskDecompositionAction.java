...
public class SelectTaskDecompositionAction extends YAWLSelectedNetAction
  ...
  
  {
    ...
    putValue(NAME, "Select Task Decomposition...");
    putValue(LONG_DESCRIPTION, "Select which decomposition this task uses.");
    putValue(SMALL_ICON, getPNGIcon("chart_organisation_add"));
