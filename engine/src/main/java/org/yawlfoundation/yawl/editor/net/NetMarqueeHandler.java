...
public class NetMarqueeHandler extends BasicMarqueeHandler {
   ...
   * Otherwise, the org.yawlfoundation.yawl.risk.state of this marquee is determined through what lies underneat
   * the mouse.
   * @param
   */
  ...
  /**
   * Sets the marquee org.yawlfoundation.yawl.risk.state based on the net element currently underneath
   * the point specified.
   * @param point
   */
   ...
   * this method will not be invoked (see { isForceMarqueeEvent(MouseEvent event)},
   * relying instead on the default behaviour of { BasicMarqueeHandler},
   ...
   * of org.yawlfoundation.yawl.risk.state transitions in this marquee handler.
   * @param point
   * @param oldState
   * @param newState
   */
