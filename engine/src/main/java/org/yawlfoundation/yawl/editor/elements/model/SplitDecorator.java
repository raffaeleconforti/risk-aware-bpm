...
public class SplitDecorator extends Decorator {
   ...
   * from saved org.yawlfoundation.yawl.risk.state. Ports will not be created with this constructor, as they
   * are already part of the JGraph org.yawlfoundation.yawl.risk.state-space.
   */
