...
public class RemoveFromVisibleCancellationSetAction extends YAWLSelectedNetAction
...

  {
    ...
    putValue(NAME, "Remove from Cancellation Set");
    putValue(LONG_DESCRIPTION, " Remove selected items from visible cancellation set ");
    putValue(SMALL_ICON, getIconByName("RemoveFromCancellationSet"));
