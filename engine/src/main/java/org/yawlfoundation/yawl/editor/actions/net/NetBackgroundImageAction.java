...
public class NetBackgroundImageAction extends YAWLSelectedNetAction {
  ...
  {
    putValue(SHORT_DESCRIPTION, " Set the net background image. ");
    putValue(NAME, "Set Net Background Image...");
    putValue(LONG_DESCRIPTION, "Set the net background image.");
    putValue(MNEMONIC_KEY, new Integer(java.awt.event.KeyEvent.VK_I));
    putValue(SMALL_ICON, getPNGIcon("picture"));
    putValue(ACCELERATOR_KEY, MenuUtilities.getAcceleratorKeyStroke("shift B"));
  }
