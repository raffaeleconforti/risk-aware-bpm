...
import org.yawlfoundation.yawl.riskMitigation.SimulatedAnnealingEngine.GreedyAlgorithm;
...
public class FirstTestRun {
    ...
    public static void main(String[] args) {
        ...
        int count = 1;
        String path = "org.yawlfoundation.yawl.riskMitigation.State.YAWL.Loaders.Process";
        ...
        while(count<181) {
            ...
            while(innerCount < 11) {
                ...
                long st = System.nanoTime();
                StateYAWLProcess set = saa.simulate(s, 50, 100, tc, 60000, 1);
                long nt = System.nanoTime();
                String stringOut = "Model: " +count+ " - Time: " +(nt-st)/1 +" -";
