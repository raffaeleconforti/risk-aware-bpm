...
//						netPos = i;
    ...
    public static void importModel(StateYAWLProcess status, HashMap<String, Object> inputVariables, HashMap<String, Resource> resourcesMap, HashMap<String, Integer> taskWithToken, List<String> tasksLog) {
