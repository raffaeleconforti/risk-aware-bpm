...
public class RemoveNetAction extends YAWLSelectedNetAction implements TooltipTogglingWidget {
...

  {
    ...
    putValue(NAME, "Remove Net");
    putValue(LONG_DESCRIPTION, "Remove the selected net ");
    putValue(SMALL_ICON, getPNGIcon("application_delete"));
    putValue(MNEMONIC_KEY, new Integer(java.awt.event.KeyEvent.VK_R));
    putValue(ACCELERATOR_KEY, MenuUtilities.getAcceleratorKeyStroke("R"));
  }
