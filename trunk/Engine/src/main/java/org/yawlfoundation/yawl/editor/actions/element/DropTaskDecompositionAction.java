...
public class DropTaskDecompositionAction extends YAWLSelectedNetAction
...

  {
    ...
    putValue(NAME, "Drop Task Decomposition...");
    putValue(LONG_DESCRIPTION, "Remove the current decomposition from this task.");
    putValue(SMALL_ICON, getPNGIcon("chart_organisation_delete"));
