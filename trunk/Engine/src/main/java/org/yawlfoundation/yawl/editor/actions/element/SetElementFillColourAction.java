...
public class SetElementFillColourAction extends YAWLSelectedNetAction
  ...
  {
    putValue(SHORT_DESCRIPTION, " Set the element's background colour. ");
    putValue(NAME, "Set Fill Colour...");
    putValue(LONG_DESCRIPTION, "Set the element's background colour.");
