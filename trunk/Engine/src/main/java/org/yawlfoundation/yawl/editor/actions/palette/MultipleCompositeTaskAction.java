...
public class MultipleCompositeTaskAction extends ControlFlowPaletteAction implements TooltipTogglingWidget {
...

  {
    ...
    putValue(NAME, "Multiple Composite Task");
    putValue(LONG_DESCRIPTION, "Add a new Multiple Composite Task");
    putValue(SMALL_ICON, getPaletteIconByName("PaletteMultipleCompositeTask"));
  }
