...
public interface ObserverGateway
{
     ...
     * suspended as opposed to entering the 'suspending' org.yawlfoundation.yawl.risk.state.
     *
     * @param caseID
     */
     ...
     * suspending org.yawlfoundation.yawl.risk.state as opposed to entering the fully 'suspended' org.yawlfoundation.yawl.risk.state.
     *
     * @param caseID
     */
    ...
    /**
     * Called by the engine to annouce when a case resumes from a previous 'suspending' or 'suspended' org.yawlfoundation.yawl.risk.state.
     *
     * @param caseID
     */
