...
public class AlignBottomAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, SpecificationSelectionSubscriber {
    ...
    
  {
    ...
    putValue(NAME, "Align along Bottom Edges");
    putValue(LONG_DESCRIPTION, "Align the selected elements along their bottom edges.");
    putValue(SMALL_ICON, getPNGIcon("shape_align_bottom"));
