...
public class MultipleAtomicTaskAction extends ControlFlowPaletteAction implements TooltipTogglingWidget {
...

  {
    ...
    putValue(NAME, "Multiple Atomic Task");
    putValue(LONG_DESCRIPTION, "Add a new Multiple Atomic Task");
    putValue(SMALL_ICON, getPaletteIconByName("PaletteMultipleAtomicTask"));
  }
