...
public class YCaseData {
	...
	/**
     * Case execution is on a normal executing org.yawlfoundation.yawl.risk.state.
     */
    ...
    /**
     * Case is resuming execution from a previously suspended or suspending org.yawlfoundation.yawl.risk.state.
     *
     * Note: This org.yawlfoundation.yawl.risk.state should never be observed via the public API.
     */
     ...
     *
     * @return Case execution org.yawlfoundation.yawl.risk.state
     */
    ...
    /**
     * Sets the execution org.yawlfoundation.yawl.risk.state of this case.
     * 
