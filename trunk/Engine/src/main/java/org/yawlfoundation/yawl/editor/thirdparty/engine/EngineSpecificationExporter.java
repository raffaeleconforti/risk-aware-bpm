...
public class EngineSpecificationExporter extends EngineEditorInterpretor {
  ...
  public static YSpecification getEngineSpecAsEngineObjects(SpecificationModel editorSpec) {
    ...
    generateSensors(editorSpec,engineSpec);
    return engineSpec;
  }
  
  private static void generateSensors(SpecificationModel editorSpec, YSpecification engineSpec) {
	engineSpec.setSensors(editorSpec.getSensors());
  }
  ...
  private static void establishEngineLocalVariables(YNet engineNet, NetGraphModel editorNet) {
    ...
    // without this intermediate variable being used for org.yawlfoundation.yawl.risk.state transport.
