...
public class CompleteResource extends XResourceAbstract{
	
	private static int activityType = Activity.Completed;
	private static int resourceType = Role.completeResourceType;
