...
public class AllocateResource extends XResourceAbstract{
	
	private static int activityType = Activity.Allocated;
	private static int resourceType = Role.allocateResourceType;
