...
public class SetRuntimePrivilegesPanel extends ResourcingWizardPanel {
  ...
  private RuntimePrivilegePanel getReallocateStatelessPanel() {
    return new RuntimePrivilegePanel(
        "Can a participant reallocate a work item of this task to another participant, resetting org.yawlfoundation.yawl.risk.state?",
  ...
  private RuntimePrivilegePanel getReallocateStatefulPanel() {
    return new RuntimePrivilegePanel(
        "Can a participant reallocate a work item of this task to another participant, retaining org.yawlfoundation.yawl.risk.state?",
