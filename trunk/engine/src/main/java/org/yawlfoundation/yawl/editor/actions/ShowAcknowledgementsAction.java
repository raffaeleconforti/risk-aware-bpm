...
public class ShowAcknowledgementsAction extends YAWLBaseAction {
  ...
  {
    putValue(SHORT_DESCRIPTION, "A message of thanks from the author.");
    putValue(NAME, "Acknowledgements...");
    putValue(LONG_DESCRIPTION, "Shows a message of thanks from the author.");
