...
public class ApplyProcessConfigurationAction extends YAWLSelectedNetAction {
    ...
    {
        putValue(SHORT_DESCRIPTION, "Apply Process Configuration");
        putValue(NAME, "Apply Process Configuration");
        putValue(LONG_DESCRIPTION, "Apply Process Configuration");
        putValue(SMALL_ICON, getPNGIcon("asterisk_yellow"));
    }
