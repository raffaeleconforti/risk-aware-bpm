 ...
 */  
  ...
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a selection set contains at least one copyable element.
   */
  public static final int STATE_COPYABLE_ELEMENTS_SELECTED = 1;
  
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a selection set contains at least one deletable element.
   */
  public static final int STATE_DELETABLE_ELEMENTS_SELECTED = 2;
  
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a selection set contains one or more elements.
   */
  public static final int STATE_ONE_OR_MORE_ELEMENTS_SELECTED = 3;
  
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a selection set contains at least two vertex elements.
   */
  public static final int STATE_MORE_THAN_ONE_VERTEX_SELECTED = 4;
  
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a seelction set contains just a single task.
   */
  public static final int STATE_SINGLE_TASK_SELECTED = 5;
  
  /**
   * Represents a org.yawlfoundation.yawl.risk.state where a seelction set contains just a single net element.
   */
   ...
   * notifications of a particular org.yawlfoundation.yawl.risk.state.
   */
   ...
   * and based on the org.yawlfoundation.yawl.risk.state of the selection set, will send events to subscribers that have asked for
   * notification of the selection being in a particular org.yawlfoundation.yawl.risk.state of interest.
   * @param model
   */
