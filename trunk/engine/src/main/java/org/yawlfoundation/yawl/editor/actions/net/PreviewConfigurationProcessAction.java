...
public class PreviewConfigurationProcessAction extends YAWLSelectedNetAction
    ...
    {
        putValue(SHORT_DESCRIPTION, "Preview Process Configuration");
        putValue(NAME, "Preview Process Configuration");
        putValue(LONG_DESCRIPTION, "Preview Process Configuration");
        putValue(SMALL_ICON, getPNGIcon("preview"));
