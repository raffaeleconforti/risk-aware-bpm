...
public class ConfigurationSettingsAction extends YAWLBaseAction
	...
	{
	    putValue(SHORT_DESCRIPTION, "Process Configuration Settings");
	    putValue(NAME, "Process Configuration...");
	    putValue(LONG_DESCRIPTION, "Process Configuration Settings");
      putValue(SMALL_ICON, getPNGIcon("wrench"));
      putValue(MNEMONIC_KEY, new Integer(java.awt.event.KeyEvent.VK_P));
      putValue(ACCELERATOR_KEY, MenuUtilities.getAcceleratorKeyStroke("shift C"));
	  }
