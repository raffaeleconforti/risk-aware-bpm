...
public class SensorMitigation extends AbstractPageBean {
    ...
    private StaticText sensorMitigation = new StaticText();

    public StaticText getsensorMitigation() { return sensorMitigation; }

    public void setsensorMitigation(StaticText st) { sensorMitigation = st; }
    ...
    private TextArea sensorMitigationText = new TextArea();

    public TextArea getsensorMitigationText() { return sensorMitigationText; }

    public void setsensorMitigationText(TextArea ta) { sensorMitigationText = ta; }
