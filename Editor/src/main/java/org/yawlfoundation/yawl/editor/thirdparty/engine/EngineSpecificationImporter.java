...
public class EngineSpecificationImporter extends EngineEditorInterpretor {
 ...
 //   reset();
  ...
  public static void convertEngineSpecObjectsToEditorObjects(
    ...
    populateSensors(editorSpec, engineSpec);
  }
  ...
  private static void populateSensors(SpecificationModel editorSpec, YSpecification engineSpecification) {
	editorSpec.setSensors(engineSpecification.getSensors());
  }
