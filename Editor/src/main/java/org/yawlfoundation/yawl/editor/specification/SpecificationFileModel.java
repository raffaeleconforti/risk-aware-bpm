...
/**
 * A singleton model of specification file org.yawlfoundation.yawl.risk.state. This model keeps track of
 * the org.yawlfoundation.yawl.risk.state of specification files, and publishes org.yawlfoundation.yawl.risk.state changes to subscribers
...
public class SpecificationFileModel {
  ...
  /**
   * org.yawlfoundation.yawl.risk.state indicating that no specification file is currently open
   */
  public static final int IDLE             = 0;

  /**
   * org.yawlfoundation.yawl.risk.state indicating that a specification file is currently open and being edited
   */
  public static final int EDITING          = 1;

  /**
   * org.yawlfoundation.yawl.risk.state indicating that some specification file operation is currently in progress
   */
   ...
   * <code>SpecificationFileModel</code> org.yawlfoundation.yawl.risk.state change.  Note that the act of subscription
   * will have the side-effect of the <code>SpecificationFileModel</code> publishing its current 
   * org.yawlfoundation.yawl.risk.state to the new subscriber only.
   * 
   * @param subscriber The object needing notification of org.yawlfoundation.yawl.risk.state change..
   * @see SpecificationFileModelListener
   */
   ...
   * This may trigger the publishing of an {@link #EDITING} org.yawlfoundation.yawl.risk.state to all subscribing
   ...
   * This may trigger the publishing of an {@link #IDLE} org.yawlfoundation.yawl.risk.state to all subscribing
   * {@link SpecificationFileModelListener} objects.
   * 
   * @see SpecificationFileModelListener
   */
   ...
   * no org.yawlfoundation.yawl.risk.state change side-effects. Note that at the moment, this method should return only 0 or 1.
   ...
   * specification file operation is in progress. This causes a publication of the {@link #BUSY} org.yawlfoundation.yawl.risk.state
