...
public class ServiceAutomatonTree implements PropertyChangeListener {
    ...
    private String currentState;       // record the Id of the node with current org.yawlfoundation.yawl.risk.state
...
/*			System.out.println("sucessors");
			...
			if(node.isFinal){
				System.out.println("This is the final org.yawlfoundation.yawl.risk.state");
			}else if (node.isInitial){
				System.out.println("This is the initial org.yawlfoundation.yawl.risk.state");
	}
			if(!node.isFinal){
...
//        }
    ...
    private class Node{
        ...
        public int shortestPathPreceder = -1; // if it is 0 , it is a org.yawlfoundation.yawl.risk.state which we can apply configuration
        public int shortestPathSucessor = -1; // if it is 0 , it is a org.yawlfoundation.yawl.risk.state which we can apply configuration
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().equals("org.yawlfoundation.yawl.risk.state")) {
