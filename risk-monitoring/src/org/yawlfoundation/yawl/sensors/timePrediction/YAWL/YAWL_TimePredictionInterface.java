...
public class YAWL_TimePredictionInterface implements TimePredictionInterface{
	...
	public static TimePredictionInterface getInstance(String timePredictionURI) {
		if(_me == null) {
			...
			TimePredictionClient.getInstance("/media/Data/SharedFolder/Demo/Log.xes", "/home/stormfire/InsuranceClaim.yawl", "/home/stormfire/Insurance.ybkp");
			File f = new File("/media/Data/SharedFolder/Demo/Log.xes");
			System.out.println(f.exists());
			f = new File("/home/stormfire/InsuranceClaim.yawl");
			System.out.println(f.exists());
			f = new File("/home/stormfire/Insurance.ybkp");
			System.out.println(f.exists());
		}
		return _me;
	}
